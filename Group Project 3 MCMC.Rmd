...
1. Construct their 95% credibility intervals for $\boldsymbol{\beta}$. What we learn from the models? Is there evidence support that the statement that "the hurrican wind speed has been increasing over years". 

2. How well does this Bayesian model track the individual hurricanes?  


3. Write a summary statement of  your findings and comment on the proposed baysian model.
