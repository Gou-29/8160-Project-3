...
\section{Distributon and priors:}
    ...
    \begin{align*}
        ...
        f(\boldsymbol{\Sigma}^{-1}) &\propto |\boldsymbol{\Sigma}|^{-d-1} \exp\{-\frac{1}{2}tr(\boldsymbol{\Sigma}^{-1})\} 
    \end{align*}
...
\begin{align*}
    ...
    &\propto \bigg(\prod^n_{i=1}\boldsymbol{\Sigma}^{-\frac{1}{2}} \exp\{-\frac{1}{2}(\boldsymbol{\beta_i}-\boldsymbol{\beta})^T\boldsymbol{\Sigma}^{-1}(\boldsymbol{\beta_i}-\boldsymbol{\beta}) \} \bigg) |\boldsymbol{\Sigma}|^{-d-1} \exp\{-\frac{1}{2}\boldsymbol{\Sigma}^{-1}\} \\
    &\propto \boldsymbol{\Sigma}^{-\frac{n}{2}-d-1} \exp\{-\frac{1}{2}\boldsymbol{\Sigma^{-1}}-\frac{1}{2}\sum^n_{i=1}(\boldsymbol{\beta_i}-\boldsymbol{\beta})^T\boldsymbol{\Sigma}^{-1}(\boldsymbol{\beta_i}-\boldsymbol{\beta})\} \\
    &\propto \boldsymbol{\Sigma}^{-\frac{n}{2}-d-1} \exp \{ \frac{1}{2}\bigg(tr(\boldsymbol{\Sigma^{-1}}) + \sum^n_{i=1}(\boldsymbol{\beta_i}-\boldsymbol{\beta})^T\boldsymbol{\Sigma}^{-1}(\boldsymbol{\beta_i}-\boldsymbol{\beta})\bigg)\}
\end{align*}

That indicate: 
$$\boldsymbol{\Sigma}^{-1} \sim \text{InvWhishart}\bigg(\frac{n}{2}, tr(\boldsymbol{\Sigma^{-1}}) + \sum^n_{i=1}(\boldsymbol{\beta_i}-\boldsymbol{\beta})^T\boldsymbol{\Sigma}^{-1}(\boldsymbol{\beta_i}-\boldsymbol{\beta})\bigg)$$
